...
const myStringSelector = AppSurge.createConfigSelector(config => config.myString, 'my default value')

const myNumberSelector = AppSurge.createConfigSelector(config => config.myNumber, 0)

const myBooleanSelector = AppSurge.createConfigSelector(config => config.myBoolean, false)
