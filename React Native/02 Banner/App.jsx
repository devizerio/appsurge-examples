...
const bannerURLSelector = AppSurge.createConfigSelector(
  (config) => config.banner.url, ""
);

const showBannerSelector = AppSurge.createConfigSelector(
  (config) => config.banner.show, false
);
